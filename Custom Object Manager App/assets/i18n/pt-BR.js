...
window.TRANSLATIONS['pt-BR'] = {
  ...
  'summary.stopLoading': 'Parar',
  'toast.bgLoadStopped': 'Carregamento interrompido — alguns registros podem estar faltando.',
  'col.id': 'ID',
  ...
  'reverseLookup.wholeWord': 'Apenas palavra inteira (menos falsos positivos)',
  ...
  'reverseLookup.linkedRecords': 'Registros vinculados (via campos lookup)',
  ...
  'reverseLookup.truncatedNote': '{section}: pesquisados {searched} de {total} campos — resultados podem estar incompletos.',
  ...
  'app.title': 'Gerenciador de Registros de Objetos Customizados (Build 202605-59)',
  ...
  'sha256.inputPlaceholder': 'Cole o valor para gerar o hash...',
  'sha256.outputLabel': 'SHA256',
  'sha256.applyBtn': 'Aplicar ao ID Externo',
  'sha256.copied': 'Copiado!',
  'sha256.applied': 'Aplicado ao campo ID Externo.',
  'sha256.suffixNote': 'O sufixo _{suffix} do ID Externo atual será preservado.',
  'app.title': 'Gerenciador de Registros de Objetos Customizados (Build 202605-61)',
};
