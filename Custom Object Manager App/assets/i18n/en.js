...
window.TRANSLATIONS.en = {
  ...
  'summary.stopLoading': 'Stop',
  'toast.bgLoadStopped': 'Background loading stopped — some records may be missing.',
  'col.id': 'ID',
  ...
  'reverseLookup.wholeWord': 'Whole-word match only (fewer false positives)',
  ...
  'reverseLookup.linkedRecords': 'Linked records (via lookup fields)',
  ...
  'reverseLookup.truncatedNote': '{section}: searched {searched} of {total} fields — results may be incomplete.',
  ...
  'app.title': 'Custom Object Record Manager (Build 202605-59)',
  ...
  'sha256.tooltip': 'Open SHA256 calculator',
  'sha256.title': 'SHA256 Calculator',
  'sha256.inputLabel': 'Input',
  'sha256.inputPlaceholder': 'Paste value to hash...',
  'sha256.outputLabel': 'SHA256',
  'sha256.applyBtn': 'Apply to External ID',
  'sha256.copied': 'Copied!',
  'sha256.applied': 'Applied to External ID field.',
  'sha256.suffixNote': 'Suffix _{suffix} from current External ID will be preserved.',
  'app.title': 'Custom Object Record Manager (Build 202605-61)',
};
